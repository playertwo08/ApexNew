...
export const metadata:Metadata={title:{default:"Apex Sports — Gear for every game",template:"%s | Apex Sports"},description:"Shop curated performance footwear, rackets, bags, and game essentials from Apex Sports Philippines.",metadataBase:new URL("https://apex-sports.openai.site"),openGraph:{title:"Apex Sports — Gear for every game",description:"Curated performance gear for athletes across the Philippines.",images:["/og.png"]},twitter:{card:"summary_large_image",title:"Apex Sports — Gear for every game",description:"Curated performance gear for athletes across the Philippines.",images:["/og.png"]}};
